...
class Task(Base):
    ...
    status: Mapped[str] = mapped_column(String(50), nullable=False, index=True, default=TaskStatus.PENDING.value)
    priority: Mapped[str] = mapped_column(String(50), nullable=False, default=TaskPriority.MEDIUM.value)
